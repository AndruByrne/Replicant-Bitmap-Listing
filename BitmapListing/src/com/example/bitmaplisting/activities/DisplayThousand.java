...
public class DisplayThousand extends Activity implements FlingListener, OnGestureListener {
//since we do not have any onClicks, it is fine to not use fragments as per instructions
	...
	private static final int rows = BitmapListing.THOUSAND_ROWS;
	...
	public boolean onCreateOptionsMenu( Menu menu ) {
		...
		show10.setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener( ){
				public boolean onMenuItemClick( MenuItem item ) {
					Intent intent = new Intent(DisplayThousand.this, DisplayTen.class);
					DisplayThousand.this.startActivity(intent);
					return false;
				}
			} );
		...
		show100.setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener( ){
				public boolean onMenuItemClick( MenuItem item ) {
				Intent intent = new Intent(DisplayThousand.this, DisplayHundred.class);
				DisplayThousand.this.startActivity(intent);
					return false;
				}
			} );
		...
		show100000.setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener( ){
				public boolean onMenuItemClick( MenuItem item ) {
					Intent intent = new Intent(DisplayThousand.this, DisplayHundredThousand.class);
					DisplayThousand.this.startActivity(intent);
					return false;
				}
			} );
