...
public class DisplayHundredThousand extends Activity implements FlingListener, OnGestureListener {
//since we do not have any onClicks, it is fine to not use fragments as per instructions
	...
	private static final int rows = BitmapListing.HUNDRED_THOUSAND_ROWS;
	...
	public boolean onCreateOptionsMenu( Menu menu ) {
		...
		show10.setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener( ){
				public boolean onMenuItemClick( MenuItem item ) {
					Intent intent = new Intent(DisplayHundredThousand.this, DisplayTen.class);
					DisplayHundredThousand.this.startActivity(intent);
					return true;
				}
			} );
		...
		show100.setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener( ){
				public boolean onMenuItemClick( MenuItem item ) {
				Intent intent = new Intent(DisplayHundredThousand.this, DisplayHundred.class);
				DisplayHundredThousand.this.startActivity(intent);
					return false;
				}
			} );
		...
		show1000.setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener( ){
				public boolean onMenuItemClick( MenuItem item ) {
					Intent intent = new Intent(DisplayHundredThousand.this, DisplayThousand.class);
					DisplayHundredThousand.this.startActivity(intent);
					return false;
				}
			} );
